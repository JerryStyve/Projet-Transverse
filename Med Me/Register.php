...
<div id="wrapper">
  ...
  <div id="content">
    <h2><span style="color:black">Enregistrement d'un nouvel utilisateur</span></h2>
    ...
    <form action="insert.php" method="post" onSubmit="return validateForm(this,arrFormValidation);" enctype="multipart/form-data" name="form2" id="form2">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="28"><div align="left">Nom:</div></td>
        ...
        <td height="28"><div align="left">Prénom:</div></td>
        ...
        <tr>
          <td height="69"><div align="left">Adresse:</div></td>
        ...
        <tr>
          <td height="37"><div align="left">Ville:</div></td>
          <td><label>
        ...
        <tr>
          <td height="27">Numéro de téléphone:</td>
        ...
        <tr>
          <td height="29">Date de naissance:</td>
        ...
        <tr>
          <td height="29">Nom d'utilisateur:</td>
