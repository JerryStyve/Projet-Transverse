...
<div id="wrapper">
  ...
  <div id="content">
    <h2><span style="color:black"> Catégorie de médecins  <?php echo $_SESSION['Name'];?></span></h2>
...
?>
      <tr>
        ...
        <td class="style3"><a href="Doctor.php?CategoryId=<?php echo $Id;?>">Regarder la page</a></td>
      </tr>
      <?php
}
